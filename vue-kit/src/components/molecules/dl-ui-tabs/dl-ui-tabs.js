...
export default {
  ...
  watch : {
    ...
    tabActive(newValue, oldValue) {
      if (this.tabs[oldValue]) {
        ...
        this.tabs[oldValue].tab.setUnselected();
      }

      if (this.tabs[newValue]) {
        // this.tabs[newValue].tab.isActive = true;
        this.tabs[newValue].tab.setSelected();
    ...
    tabs() {
      if (this.tabs.length > 0) {
        ...
        this.tabs[this.tabActive].tab.setSelected();
      }
    }
  },
  computed : {
  ...
  methods : {
    ...
    removeTab(index) {
      ...
      this.tabs[index].tab.setUnselected();
