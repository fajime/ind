...
export default {
  name       : 'dl-ui-view-__DEMO-dl-ui-vertical-menu',
  components : {
    theComponent,
    ...
    return {
      playground : {
        ...
        style : {
          ...
          value   : '',
          options : [
            { name : 'Default', value : 'dl-ui-vertical-menu--large' },
            { name : 'Small', value : 'dl-ui-vertical-menu--small' },
            { name : 'Large', value : 'dl-ui-vertical-menu--large' },
            { name : 'Custom', value : 'custom-vertical-menu' }
          ]
        }
      },
