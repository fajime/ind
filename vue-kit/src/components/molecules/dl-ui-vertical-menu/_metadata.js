// DEMO META DATA
export default {
  titleName            : 'Vertical Menu',
  nameJS               : 'DlUiVerticalMenu',
  type                 : 'molecule',
  nameScssMixin        : 'vertical-menu-style-config',
  nameScssDefaultClass : 'dl-ui-vertical-menu',
  nameScssMixinFile    : 'vertical-menu',
