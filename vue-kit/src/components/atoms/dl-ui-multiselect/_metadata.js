// DEMO META DATA
export default {
  titleName            : 'Multiselect',
  nameJS               : 'DlUiMultiselect',
  type                 : 'atom',
  nameScssMixin        : 'multiselect-style-config',
  nameScssDefaultClass : 'dl-ui-multiselect',
  nameScssMixinFile    : 'multiselect',
  description          : `<p>El multiselect simple permite al usuario escoger múltiples valores entre varios, de un menú desplegable.</p>
