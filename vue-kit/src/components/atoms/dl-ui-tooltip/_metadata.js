...
export default {
  ...
  description          : `<p>Los tooltips son pequeñas cajas de texto a modo de popup que pueden dar información adicional sobre cualquier elemento html sobre el que se añadan, como descripción o funcionalidad que el elemento lleva asociada.</p>
                            <p>El tooltip NO es un componente vue, es una directiva de vue, siendo necesario utilizarlo como tal. Las propiedades descritas más abajo <span style="font-weight:bold">NO son</span> directas al tooltip, sino tan solo al componente de pruebas del playground para poder visualizar su comportamiento.</p>
    ...
    <div class="dl-comp-kit-demo-use__code">
        <pre>
            <code class="javascript">
              ...
              import dlUiTooltip from '@indra-dl/dl-fmwk-vue-comp-kit/src/directives/dl-ui-tooltip';       
              export default {
                name       : 'dl-ui-compo',
